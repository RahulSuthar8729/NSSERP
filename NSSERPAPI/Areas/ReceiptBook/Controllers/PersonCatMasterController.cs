...
namespace NSSERPAPI.Areas.ReceiptBook.Controllers
{
    ...
    public class PersonCatMasterController : Controller
    {
        ...
        public PersonCatMasterController(Db_functions dbFunctions, IConfiguration configuration)
        {
        ...
        [HttpPost]
        public IActionResult InsertData([FromBody] PersonCatMaster model)
        {
            try
            {
        ...
        [HttpPost]
        public IActionResult UpdateData([FromBody] PersonCatMaster model)
        {

            try
            {
                var result = _dbEngine.ExecuteUpdateStoredProcedure("[updatepersoncategorymaster]", model.code, model);
                return Ok(result);
            }
            catch (Exception ex)
            {
